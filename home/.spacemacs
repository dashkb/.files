...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Source Code Pro for Powerline"
                               :size 24
                               :weight normal
                               :width normal :powerline-scale 1.1) ;; The leader key
