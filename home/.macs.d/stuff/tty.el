...
;;
;; Works in Emacs 20 if you have ansi-color.el.  Its separately published
;; version 3.4.5 works if you load cl.el for `mapc'.  But note in Emacs 20
;; faces don't display on a tty, only under X or similar GUI.
